    ...
    <div class="flex flex-col mt-12">
        <div class="w-full p-6">
            <div class="flex justify-start items-center">
                <h1 class="font-bold text-5xl tracking-widest ml-20">Events</h1>
            </div>
        </div>
                ...
                <tbody class="bg-gray-800">
                    @foreach($event as $item)
                        <tr class="border-b ">
                            ...
                            <td class="py-4 px-6">
                                <img src="{{ asset('uploads/events/'.$item->picture) }}" class="w-12 h-12" alt="image" />
                            </td>
                            <td class="py-4 px-6">
                               {{ $item->dateHappening }}
                            </td>
                            ...
                            <td class="flex py-4 px-12 text-right">
                                <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-10">
